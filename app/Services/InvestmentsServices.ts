    ...
    public async createNewInvestment(createInvestment: InvestmentType, amountToInvest: number): Promise<Investment> {
        try {
            ...
            if (investmentTypeDetails) {
                ...
                AstraPay Investment.`;
                        let newNotificationMessage = await sendNotification(email, subject, firstName, message);
                        // console.log("newNotificationMessage line 366:", newNotificationMessage);
                        // debugger
                        if (newNotificationMessage.status == 200 || newNotificationMessage.message == "Success") {
                            console.log("Notification sent successfully");
                        } else if (newNotificationMessage.message !== "Success") {
                ...
                AstraPay Investment.`;
                        let newNotificationMessage = await sendNotification(email, subject, firstName, message);
                        // console.log("newNotificationMessage line 557:", newNotificationMessage);
                        // debugger
                        if (newNotificationMessage.status == 200 || newNotificationMessage.message == "Success") {
                            console.log("Notification sent successfully");
                        } else if (newNotificationMessage.message !== "Success") {
                ...
                AstraPay Investment.`;
                        let newNotificationMessage = await sendNotification(email, subject, firstName, message);
                        // console.log("newNotificationMessage line 641:", newNotificationMessage);
                        // debugger
                        if (newNotificationMessage.status == 200 || newNotificationMessage.message == "Success") {
                            console.log("Notification sent successfully");
                        } else if (newNotificationMessage.message !== "Success") {
            ...
            if (approvalIsAutomated === false) {
                ...
                // console.log('Timeline object line 826:', timelineObject)
                await timelineService.createTimeline(timelineObject);
                // Send Details to notification service
    ...
    public async collateMaturedInvestment(queryParams: any): Promise<Investment[] | any> {
        ...
        try {
            ...
            const processInvestment = async (investment) => {
                ...
                AstraPay Investment.`;
                                    let newNotificationMessage = await sendNotification(email, subject, firstName, message);
                                    // console.log("newNotificationMessage line 1693:", newNotificationMessage);
                                    // debugger
                                    if (newNotificationMessage.status == 200 || newNotificationMessage.message == "Success") {
                                        console.log("Notification sent successfully");
                                    } else if (newNotificationMessage.message !== "Success") {
    ...
    public async reactivateSuspendedPayoutInvestmentByInvestmentId(investmentId: string, queryParams: any): Promise<Investment[] | any> {
        ...
        try {
            ...
            const processInvestment = async (investment) => {
                ...
                AstraPay Investment.`;
                                    let newNotificationMessage = await sendNotification(email, subject, firstName, message);
                                    // console.log("newNotificationMessage line 2711:", newNotificationMessage);
                                    // debugger
                                    if (newNotificationMessage.status == 200 || newNotificationMessage.message == "Success") {
                                        console.log("Notification sent successfully");
                                    } else if (newNotificationMessage.message !== "Success") {
    ...
    public async reactivateSuspendedRolloverInvestment(queryParams: any): Promise<Investment[] | any> {
        ...
        try {
            ...
            const processInvestment = async (investment) => {
                ...
                AstraPay Investment.`;
                                let newNotificationMessage = await sendNotification(email, subject, firstName, message);
                                // console.log("newNotificationMessage line 3008:", newNotificationMessage);
                                // debugger
                                if (newNotificationMessage.status == 200 || newNotificationMessage.message == "Success") {
                                    console.log("Notification sent successfully");
                                } else if (newNotificationMessage.message !== "Success") {
                ...
                AstraPay Investment.`;
                                    let newNotificationMessage = await sendNotification(email, subject, firstName, message);
                                    // console.log("newNotificationMessage line 3072:", newNotificationMessage);
                                    // debugger
                                    if (newNotificationMessage.status == 200 || newNotificationMessage.message == "Success") {
                                        console.log("Notification sent successfully");
                                    } else if (newNotificationMessage.message !== "Success") {
                ...
                AstraPay Investment.`;
                                let newNotificationMessage = await sendNotification(email, subject, firstName, message);
                                // console.log("newNotificationMessage line 3189:", newNotificationMessage);
                                // debugger
                                if (newNotificationMessage.status == 200 || newNotificationMessage.message == "Success") {
                                    console.log("Notification sent successfully");
                                } else if (newNotificationMessage.message !== "Success") {
                                ...
                                if (investment.status !== 'completed' && investment.status == 'rollover_suspended') {
                                    ...
                                    let subject = "AstraPay Investment Payout Reactivation";
                                    let message = `
                ${firstName} your mature investment has just been sent for 3250 processing.
                ...
                AstraPay Investment.`;
                                    let newNotificationMessage = await sendNotification(email, subject, firstName, message);
                                    // console.log("newNotificationMessage line 3258:", newNotificationMessage);
                                    // debugger
                                    if (newNotificationMessage.status == 200 || newNotificationMessage.message == "Success") {
                                        console.log("Notification sent successfully");
                                    } else if (newNotificationMessage.message !== "Success") {
        ...
        try {
            ...
            const processInvestment = async (investment) => {
                ...
                AstraPay Investment.`;
                    ...
                    console.log(error)
                    // debugger
                    console.log("Error line 3077", error.messages);
                    console.log("Error line 3078", error.message);
                    // console.log("Error line 3079", error.message);
                    // debugger
                    await trx.rollback()
                    console.log(`Error line 3082, status: "FAILED",message: ${error.messages} ,hint: ${error.message},`)
                    throw error;
                }
            }
    ...
    public async liquidateInvestment(investmentId: string, queryParams: any, loginUserData?: any): Promise<Investment[] | any> {
        ...
        try {
            ...
            const processInvestment = async (investment) => {
                ...
                try {
                    ...
                    if (isAllPayoutSuspended === false) {
                        if (investment) {
                            ...
                            // let startDate = DateTime.now().minus({ days: 5 }).toISO()
                            // let duration = 4
                            console.log('Time investment was started line 6018: ', startDate)
                            // let timelineObject
                            // let timeline
                            let isDueForPayout = await dueForPayout(startDate, duration)
                            console.log('Is due for payout status line 6022:', isDueForPayout)
                            // debugger
                            if (isDueForPayout === true) {
                                //                          record.isPayoutAuthorized === true,
                                //   record.isPayoutSuspended === false,
                ...
                AstraPay Investment.`;
                                ...
                                if ((record.requestType === "start_investment" && record.approvalStatus === "approved" && record.isPayoutAuthorized === true &&
                                    ...
                                    if (creditUserWalletWithPrincipal.status == 200 && creditUserWalletWithInterest.status == 200) {
                                        ...
                                        // update record
                                        let currentInvestment = await investmentsService.getInvestmentsByIdAndWalletIdAndUserId(investmentId, walletIdToSearch, userIdToSearch);
                                        // console.log(" Current log, line 6425 :", currentInvestment);
                                        // send for update
                                        await investmentsService.updateInvestment(currentInvestment, record);
                                        // let updatedInvestment = await investmentsService.updateInvestment(currentInvestment, record);
                                        // console.log(" Current log, line 6429 :", updatedInvestment);

                                        // console.log("Updated record Status line 6431: ", record);
                ...
                AstraPay Investment.`;
                                        let newNotificationMessage = await sendNotification(email, subject, firstName, message);
                                        // console.log("newNotificationMessage line 6457:", newNotificationMessage);
                                        // debugger
                                        if (newNotificationMessage.status == 200 || newNotificationMessage.message == "Success") {
                                            console.log("Notification sent successfully");
                                        } else if (newNotificationMessage.message !== "Success") {
