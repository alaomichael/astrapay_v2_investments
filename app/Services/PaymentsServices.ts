        ...
        try {
            ...
            for (let index = 0; index < responseData.length; index++) {
                ...
                try {
                    ...
                    // throw error;
                    console.log("Error line 2329:", error);
        ...
        try {
            ...
            for (let index = 0; index < responseData.length; index++) {
                ...
                try {
                    ...
                    // throw error;
                    console.log("Error line 2920:", error);
                    const timestamp = new Date().toISOString();
                    const errorLog = `Error occurred at ${timestamp}: ${error.message}\n`;
                    fs.appendFileSync('error.log', errorLog);
                    // Continue to the next iteration of the loop instead of throwing the error
        ...
        try {
            ...
            for (let index = 0; index < responseData.length; index++) {
                ...
                try {
                    ...
                    // throw error;
                    console.log("Error line 3276:", error);
                    const timestamp = new Date().toISOString();
                    const errorLog = `Error occurred at ${timestamp}: ${error.message}\n`;
                    fs.appendFileSync('error.log', errorLog);
                    // Continue to the next iteration of the loop instead of throwing the error
        ...
        try {
            ...
            for (let index = 0; index < responseData.length; index++) {
                ...
                try {
                    ...
                    // throw error;
                    console.log("Error line 3878:", error);
                    const timestamp = new Date().toISOString();
                    const errorLog = `Error occurred at ${timestamp}: ${error.message}\n`;
                    fs.appendFileSync('error.log', errorLog);
                    // Continue to the next iteration of the loop instead of throwing the error
        ...
        try {
            ...
            for (let index = 0; index < responseData.length; index++) {
                ...
                try {
                    ...
                    // throw error;
                    console.log("Error line 4435:", error);
                    const timestamp = new Date().toISOString();
                    const errorLog = `Error occurred at ${timestamp}: ${error.message}\n`;
                    fs.appendFileSync('error.log', errorLog);
                    // Continue to the next iteration of the loop instead of throwing the error
        ...
        try {
            ...
            for (let index = 0; index < responseData.length; index++) {
                ...
                try {
                    ...
                    // console.log("Error line 2766:", error);
                    // throw error;
                    console.log("Error line 4967:", error);
                    const timestamp = new Date().toISOString();
                    const errorLog = `Error occurred at ${timestamp}: ${error.message}\n`;
                    fs.appendFileSync('error.log', errorLog);
                    // Continue to the next iteration of the loop instead of throwing the error
        ...
        try {
            ...
            for (let index = 0; index < responseData.length; index++) {
                ...
                try {
                    ...
                    // throw error;
                    console.log("Error line 5495:", error);
                    const timestamp = new Date().toISOString();
                    const errorLog = `Error occurred at ${timestamp}: ${error.message}\n`;
                    fs.appendFileSync('error.log', errorLog);
                    // Continue to the next iteration of the loop instead of throwing the error
        ...
        try {
            ...
            for (let index = 0; index < responseData.length; index++) {
                ...
                try {
                    ...
                    // console.log("Error line 3308:", error);
                    // throw error;
                    console.log("Error line 6011:", error);
                    const timestamp = new Date().toISOString();
                    const errorLog = `Error occurred at ${timestamp}: ${error.message}\n`;
                    fs.appendFileSync('error.log', errorLog);
                    // Continue to the next iteration of the loop instead of throwing the error
        ...
        try {
            ...
            for (let index = 0; index < responseData.length; index++) {
                ...
                try {
                    ...
                    // console.log("Error line 4656 =====================:", error);
                    // throw error;
                    console.log("Error line 6703:", error);
                    const timestamp = new Date().toISOString();
                    const errorLog = `Error occurred at ${timestamp}: ${error.message}\n`;
                    fs.appendFileSync('error.log', errorLog);
                    // Continue to the next iteration of the loop instead of throwing the error
        ...
        try {
            ...
            for (let index = 0; index < responseData.length; index++) {
                ...
                try {
                    ...
                    // throw error;
                    console.log("Error line 7839:", error);
                    const timestamp = new Date().toISOString();
                    const errorLog = `Error occurred at ${timestamp}: ${error.message}\n`;
                    fs.appendFileSync('error.log', errorLog);
                    // Continue to the next iteration of the loop instead of throwing the error
        ...
        try {
            ...
            for (let index = 0; index < responseData.length; index++) {
                ...
                try {
                    ...
                    // throw error;
                    console.log("Error line 8600:", error);
                    const timestamp = new Date().toISOString();
                    const errorLog = `Error occurred at ${timestamp}: ${error.message}\n`;
                    fs.appendFileSync('error.log', errorLog);
                    // Continue to the next iteration of the loop instead of throwing the error
        ...
        try {
            ...
            for (let index = 0; index < responseData.length; index++) {
                ...
                try {
                    ...
                    // throw error;
                    console.log("Error line 9848:", error);
                    const timestamp = new Date().toISOString();
                    const errorLog = `Error occurred at ${timestamp}: ${error.message}\n`;
                    fs.appendFileSync('error.log', errorLog);
                    // Continue to the next iteration of the loop instead of throwing the error
