...
// }
        ...
        //       "rfi": {
        //     "id": "855da036-4338-4769-beb6-b31120d6b29e",
        //     "code": "duran",
        //     "isVerified": true,
        //     "name": "Duran Hodge Co",
        //     "registrationNumberType": "Qui in ea dolores ve",
        //     "registrationNumber": "Dolore quod commodo",
        //     "memorandomOfAssociationUrl": "406cb56d-b47f-4a1e-93bf-c4f0209af44esideA.png",
        //     "email": "nali@mailinator.com",
        //     "street": "Velit nostrud quidem",
        //     "city": "Non dolor accusamus",
        //     "state": "Ullam ipsum consequa",
        //     "country": "Rerum quibusdam quod",
        //     "createdBy": "08102872652",
        //     "isDeleted": false,
        //     "createdAt": "2023-03-08T11:45:50.337+00:00",
        //     "updatedAt": "2023-03-09T15:07:10.309+00:00",
        //     "onboardingState": "Go Live",
        //     "verificationStatus": "VERIFIED",
        //     "isUpdateRequired": false,
        //     "isOnboardingMeetingHeld": true,
        ...
        //     "isRootUserCreated": true,
        //     "status": "Active",
        //     "contactPersonEmail": "Tolaninuel2@gmail.com",
        //     "contactPersonFirstname": "Tolani",
        //     "contactPersonSurname": "Nuel",
        //     "isContactPersonEmailVerified": true,
        //     "isRootUserEmailVerified": true,
        //     "realm": "duran",
        //     "rfiOnboardingStep": "6",
        //     "isRootUserRequested": true,
        //     "rootUserRequestedAt": "2023-03-09T14:52:20.948+00:00",
        //     "cba": "Sagamy",
        //     "cbaUrl": "https://sagamy.com",
        //     "rfiSmsBillingAccountNumber": null,
        //     "rfiSmsBillingAccountName": null,
        //     "rfiSmsBillingAccountBfiCode": null,
        //     "vatAccountNumber": null,
        //     "vatAccountBfiCode": null,
        //     "vatAccountName": null,
        //     "serviceChargeAccountName": null,
        //     "serviceChargeAccountNumber": null,
        //     "serviceChargeAccountBfiCode": null
        // },
            debugger

            console.log("content line 401 ===== ", name, email, )
            console.log("content line 402 ===== ", code, status,)
            // Check if the record is existing
            const rfiRecordsService = new RfiRecordsServices();
            ...
            debugger
            if (!rfiRecord) {
                console.log("payload line 430 ===== ", payload)
                console.log('Consumer by server, RFI Record does not exist, line 431 =====');
                debugger
                // throw Error();
                let rfiNameExist = await rfiRecordsService.getRfiRecordByRfiRecordRfiName(payload.rfiName);
                if (rfiNameExist) {
                ...
                let rfiCodeExist = await rfiRecordsService.getRfiRecordByRfiRecordRfiCode(payload.rfiCode);
                if (rfiCodeExist) {
                    console.log('Consumer cancelled by server, line 445 =====');
                    console.log(`rfiCode ${payload.rfiCode} already exist`);
                    debugger
                    //@ts-ignore
                    throw Error(`rfiCode ${payload.rfiCode} already exist`);
                ...
                let phone2Exist = await rfiRecordsService.getRfiRecordByRfiRecordPhone2(payload.phone2);
                if (phone2Exist && phone2Exist.phone2 != `${payload.rfiName} phone2 was not provided`) {
                    console.log('Consumer cancelled by server, line 463 =====');
                    console.log(`phone2 ${payload.phone2} already exist`);
                    debugger
                    //@ts-ignore
                    // throw Error(`phone2 ${payload.phone2} already exist`);
                ...
                let emailExist = await rfiRecordsService.getRfiRecordByRfiRecordEmail(payload.email);
                if (emailExist) {
                    console.log('Consumer cancelled by server, line 472 =====');
                    console.log(`email ${payload.email} already exist`);
                    debugger
                    //@ts-ignore
                    // throw Error(`email ${payload.email} already exist`);
                ...
                let websiteExist = await rfiRecordsService.getRfiRecordByRfiRecordWebsite(payload.website);
                if (websiteExist && websiteExist.website != `http://www.${payload.rfiName}.no_website_provided.com`) {
                    console.log('Consumer cancelled by server, line 481 =====');
                    console.log(`website ${payload.website} already exist`);
                    debugger
                    //@ts-ignore
                    // throw Error(`website ${payload.website} already exist`);
                ...
                let sloganExist = await rfiRecordsService.getRfiRecordByRfiRecordSlogan(payload.slogan);
                if (sloganExist && sloganExist.slogan != `${payload.rfiName} slogan was not provided`) {
                    console.log('Consumer cancelled by server, line 490 =====');
                    console.log(`slogan ${payload.slogan} already exist`);
                    debugger
                    //@ts-ignore
                    // throw Error(`slogan ${payload.slogan} already exist`);
                ...
                debugger
                if (!rfiRecord) {
                    console.log('Consumer cancelled by server, line 150072 =====');
                    throw Error(rfiRecord);
                }
                console.log("New RFI record created successfully line 503 ===== ")
                

            } else {
                console.log("payload for existing RFI record line 507 ===== ", payload)
...
debugger
                ...
                if (!selectedSetting) {
                    ...
                    console.log("Existing RFI record, investment config setting created successfully line 601 ===== ")
                } else {
                    const payload2: SettingType = {
