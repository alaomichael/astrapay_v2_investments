        ...
        try {
            ...
            if (investmentWalletId) {
                ...
                const serviceAccount: ServiceAccountType = {
                    ...
                    // @ts-ignore
                    rfiId: rfiRecord?.id,//"9d72e2a1-c7d2-41a1-9d99-6430019596a5",
                    name: "Investment Deposit Wallet Service Account", //rfiName,//
                    accountName: rfiName,//"Astra polaris",
                    bfiCode: rfiCode, //"apmfb",
                    bfiName: rfiName,//"Astra Polaris",
                    rfiCode: rfiCode,//"ASD",
            ...
            if (payoutWalletId) {
                ...
                const serviceAccount: ServiceAccountType = {
                    ...
                    // @ts-ignore
                    rfiId: rfiRecord?.id,//"9d72e2a1-c7d2-41a1-9d99-6430019596a5",
                    name: "Investment Payout Wallet Service Account", //rfiName,//
                    accountName: rfiName,//"Astra polaris",
                    bfiCode: rfiCode, //"apmfb",
                    bfiName: rfiName,//"Astra Polaris",
                    rfiCode: rfiCode,//"ASD",
...
//                 {
//     "name":"Wallet to Other Bank Service Account",
...
//     "customerReference":"123458",
//     "serviceName":"Banking Service",
//     "serviceDescription":"Banking service",
