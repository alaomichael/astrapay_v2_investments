...
export const getUserWalletsById01 = async function getUserWalletsById01(
    userId
): Promise<any> {
    try {
        ...
        //         }, cb);
        // // >> "cb(generatedString) {}"
        // console.log("Before AXIOS CALL ,@ getUserWalletsById01 ==================================================");
        ...
        // console.log("After AXIOS CALL,@ getUserWalletsById01 ==================================================");
        // console.log("The ASTRAPAY API response,line 51: ");
        // console.log( response);
        // debugger
        if (response.status === 200) {
            //  && response.data
            // console.log("The ASTRAPAY API response,,@ getUserWalletsById01 line 68: ", response.data);
            if (response) {
                return response.data;
          }
        } else {
            // console.log("The ASTRAPAY API response,,@ getUserWalletsById01 line 58: ", response);
            return response;
        }
    } catch (error) {
