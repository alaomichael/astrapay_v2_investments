...
export const getUserWalletBalanceRecord01 = async function getUserWalletBalanceRecord01(
    startDate,
    endDate,
    walletId
): Promise<any> {
    ...
    try {
        ...
        // console.log("The ASTRAPAY API response status: @  getUserWalletBalanceRecord01 line 37 ", response.status);
        ...
        console.log(" The ASTRAPAY API response status: @  getUserWalletBalanceRecord01 line 48 ==================================================");
