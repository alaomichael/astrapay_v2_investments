...
export default class UpdateRfiRecordValidator extends BaseValidator {
    ...
    public schema = schema.create({
        ...
        phone: schema.string.optional({ escape: true },
            [rules.maxLength(255), rules.unique({
                table: 'rfi_records',
                column: 'phone'
            })]
        ...
        website: schema.string.optional({ escape: true },
            [rules.maxLength(255), rules.unique({
                table: 'rfi_records',
                column: 'website'
            }), rules.url()]
        ...
        imageUrl: schema.string.optional({ escape: true },
            [rules.maxLength(255), rules.unique({
                table: 'rfi_records',
                column: 'image_url'
            })]
        ),
        address: schema.string.optional({ escape: true },
            [rules.maxLength(255), rules.unique({
                table: 'rfi_records',
                column: 'address'
            })]
